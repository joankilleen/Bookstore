...
public class CustomerServiceBean implements CustomerService {
    ...
    @Override
    public Customer registerCustomer(Customer customer, String password) throws CustomerAlreadyExistsException {
        log("registering new cutomer: " + customer);
        System.out.println("registering new cutomer: " + customer);
    ...
    @Override
    public Customer findCustomer(String customerNr) throws CustomerNotFoundException {
    ...
    public void updateCustomer(Customer customer) throws CustomerNotFoundException, CustomerAlreadyExistsException {
        ...
        Customer customerInDB = findCustomer(customer.getNumber());
        ...
        Customer customerWithNewEmail = customerDAO.findByEmail(customer.getEmail());
